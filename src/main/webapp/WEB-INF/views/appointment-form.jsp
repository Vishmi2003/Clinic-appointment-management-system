...
<%@ page import="java.util.Map,java.util.Set,lk.sunrise.dental.web.WebUtil" %>
...
<form class="card appointment-form" action="<%= contextPath %>/appointments/new" method="post">
    ...
    <section class="form-section">
        <div class="form-section__title"><span>3</span><div><h3>Treatment & schedule</h3><p>Choose the dentist, treatment, date and time.</p></div></div>
        <div class="form-grid form-grid--two">
            <label class="form-field">
