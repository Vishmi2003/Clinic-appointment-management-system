            ...
            <div class="appointment-list">
                <% for (Appointment item : upcoming) { %>
                    <a class="appointment-row" href="<%= contextPath %>/appointments/search?number=<%= WebUtil.escapeHtml(item.getAppointmentNumber()) %>">
                        ...
                        <div class="appointment-row__main"><strong><%= WebUtil.escapeHtml(item.getPatientName()) %></strong><span><%= WebUtil.escapeHtml(item.getTreatmentType()) %> • <%= WebUtil.escapeHtml(item.getDentistName()) %></span></div>
